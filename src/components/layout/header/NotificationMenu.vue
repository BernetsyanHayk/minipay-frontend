...
const notifications = ref([
  ...
  {
    id: 3,
    action: 'Top-up of $100 completed',
    project: 'Wallet - Bank Card',
    type: 'Success',
    time: '10 min ago',
  },
  {
    id: 4,
    action: 'Login attempt from unknown device',
    project: 'Security',
    type: 'Warning',
    time: '15 min ago',
  },
  {
    id: 5,
    action: 'Your card will expire soon',
    project: 'Payment Method - Visa ****1234',
    type: 'Warning',
    time: '30 min ago',
  },
  {
    id: 6,
    action: '2FA was disabled on your account',
    project: 'Security',
    type: 'Warning',
    time: '1 hour ago',
  },
  {
    id: 7,
    action: 'Transaction failed due to insufficient funds',
    project: 'Wallet - EUR',
    type: 'Error',
    time: '2 hours ago',
  },
  {
    id: 8,
    action: 'Failed to add payment method',
  ...
  {
    id: 10,
    action: 'Password reset link sent to your email',
  ...
  {
    id: 11,
    action: 'New version of MiniPay is available',
  ...
  {
    id: 12,
    action: 'Support replied to your request',
